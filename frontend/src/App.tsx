...
function App() {
  ...
  return (
    ...
    >
        ...
        >
            ...
            <Navbar.Collapse>
              <Nav className="w-100 justify-content-end">
                ...
                {userInfo ? (
                  ...
                  <NavDropdown className="header-link" title={`Hola, ingresar`}>
          ...
          <div className="sub-header">
            <div className="d-flex">
              ...
              >
                <i className="fas fa-bars"></i> Todo
              </Link>
              {['Ofertas', 'Regalos', 'En Oferta'].map((x) => (
                <Link
                  key={x}
      ...
      >
        <ListGroup variant="flush">
          <ListGroup.Item action className="side-navbar-user">
            ...
            >
              <span>
                {userInfo ? `Hola, ${userInfo.name}` : `Hola, ingresar`}
              </span>
            </LinkContainer>
          </ListGroup.Item>
          <ListGroup.Item>
      ...
      <footer>
        <div className="text-center">Todos los derechos reservados - {new Date().getFullYear()} Techmart</div>
      </footer>
    </div>
  )
}
